...
*/       
 ...
 //error_log( print_r(  'Bulk Rule processing', true ) );   
      ...
      //error_log( print_r(  '$sizeof_bulk_deal_array= ' .$sizeof_bulk_deal_array, true ) );
      //error_log( print_r(  '$last_bulk_row_occurs= ' .$last_bulk_row_occurs, true ) );  
      ...
      //error_log( print_r(  'inPop_qty_total= ' .$vtprd_rules_set[$i]->inPop_qty_total, true ) );
      //error_log( print_r(  'inPop_total_price= ' .$vtprd_rules_set[$i]->inPop_total_price, true ) );
      //error_log( print_r(  'bulk_deal_array, $b= ' .$b, true ) );
      //error_log( var_export($vtprd_rules_set[$i]->bulk_deal_array[$b], true ) );  
      ...
      //error_log( print_r(  'bulk_deal_processing_array at path002 time= ', true ) );
      //error_log( var_export($vtprd_rules_set[$i]->bulk_deal_processing_array, true ) );
              ...
              //error_log( print_r(  'in the for loop ', true ) );
              //error_log( print_r(  'inPop_qty_total= ' .$vtprd_rules_set[$i]->inPop_qty_total, true ) );
              //error_log( print_r(  'inPop_total_price= ' .$vtprd_rules_set[$i]->inPop_total_price, true ) );
              //error_log( print_r(  'bulk_deal_array, $b= ' .$b, true ) );
              //error_log( var_export($vtprd_rules_set[$i]->bulk_deal_array[$b], true ) );  
                      ...
                      switch ( $vtprd_rules_set[$i]->bulk_deal_method ) { 
                          ...
                          case ('currency'):    
              //error_log( print_r(  'in currency case ', true ) );                                                  
      ...
      //error_log( print_r(  'bulk_deal_processing_array at path004 time= ', true ) );
      //error_log( var_export($vtprd_rules_set[$i]->bulk_deal_processing_array, true ) );
            ...
            if (!$occurrence_found) {
 //error_log( print_r(  'Bulk Rows - No occurrence found', true ) );            
  ...
  public function vtprd_bulk_find_currency_actionpop_end($i, $b, $sizeof_actionPop_exploded_found_list) {
      ...
      //error_log( print_r(  'bulk_deal_processing_array at WRITE time= ', true ) );
      //error_log( var_export($vtprd_rules_set[$i]->bulk_deal_processing_array, true ) );
...
//error_log( print_r(  'Inpop end reached ' , true ) );      
 ...
 exceeds the product's cumulative quantity discount.
  ...
  //$remainder = $yousave_pct_prod_temp - $yousave_pct_prod_2decimals;
    ...
    //error_log( print_r(  'bulk_deal_processing_array at READ time= ', true ) );
    //error_log( var_export($vtprd_rules_set[$i]->bulk_deal_processing_array, true ) );
