...
class VTPRD_Controller{
    ...
    if(!isset($_SESSION)){
      ...
      header("Pragma: no-cache");
		...
		define('VTPRD_VERSION',                               '1.1.8.0');
    define('VTPRD_MINIMUM_PRO_VERSION',                   '1.1.8.0'); 
    define('VTPRD_LAST_UPDATE_DATE',                      '2017-10-21');
    ...
    define('VTPRD_ADMIN_CSS_FILE_VERSION',                'v003b'); //v1.1.7.1a new version  ==> use to FORCE pickup of new CSS
    define('VTPRD_ADMIN_JS_FILE_VERSION',                 'v003b'); //v1.1.7.1a new version  ==> use to FORCE pickup of new JS
