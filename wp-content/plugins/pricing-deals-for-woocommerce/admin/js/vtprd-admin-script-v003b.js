 ...
 */
            ...
            //*************************************                             
                          ...
                          function setBulkDiscount() { 
                             ...
                             $("#bulk-box").show(); //show pricing table
                             $(".bulk-checkout-msg").show(); //show comment for short checkout msg with wildcard
            ...
            //***********************************************************************
                          ...
                          function advancedSelected() {   
                           ...
                           //   $("#buy_amt_mod_box_0").show("slow"); v1.1.8.0
                          //    $("#buy_repeat_box_0").show("slow"); v1.1.8.0
                          //    $("#action_amt_mod_box_0").show("slow"); v1.1.8.0
                             ...
                             /* $(".buy_group_title-area").show("slow");
                              ...
                              if ( $("#pricing-type-select").val() == 'bulk') {
                                 ...
                                 $("#discount_amt_row_0").show("slow"); //Discount Amount Type disable                              
                              };                                
                          };
                            ...
                            $("#deal-type-title-less").click(function(){
                             ...
                             function show_selection_panel_A() {     
                              ...
                              switch( $("#rule_template_framework").val() ) {                                
                                ...
                                case "C-bulkDiscount":          $(".selection-panel-A-4").show("slow");   break;  //v1.1.8.0
