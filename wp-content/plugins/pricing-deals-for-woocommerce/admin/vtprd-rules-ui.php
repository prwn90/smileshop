  ...
  public function vtprd_enqueue_admin_scripts() {
    ...
    if( get_post_type() == 'vtprd-rule' ){         //v1.0.8.2   can't just test $post_type here, not always accurate!
       ...
       //qtip resources named jquery-qtip, to agree with same name used in wordpress-seo from yoast!
        ...
        //v1.1.8.0 begin
        //add line on demand, activate tabs
        //  JS vtprd-admin-add-line-and-tabs now part of admin-script JS
        //ui tabs part of WP, already registered!  UI core already loaded above with datepicker...   
        // Comprehensive CSS already loaded above with datepicker
                   ...
                   <span class="" id="pricing_table_CountBy_box"> 
                       <span class="pricing_table_CountBy_type">
                          ...
                          <select id="bulkCountByIn" class="clear-left" name="bulkCountByIn" tabindex="">                                                                                            
                              <option id="bulkCountByCurrency" class="bulkCountByInOptions"  <?php echo $bulk_deal_CountBy_all;?> value="all" ><?php _e('All &nbsp;&nbsp;- &nbsp; count together as a group ', 'vtprd'); //  &nbsp;&nbsp; ex: "Buy 5 shirts get a discount" '?></option> 
                              <option id="bulkCountByUnits" class="bulkCountByInOptions" <?php echo $bulk_deal_CountBy_each;?> value="each" ><?php _e('Each &nbsp;&nbsp;-&nbsp; count each individual cart line item total ', 'vtprd');  //  &nbsp;&nbsp;  ex: "Buy 5 units of any one shirt..." ?></option>                                                                                 
                          </select>
                       </span>
                  </span>    
                </div>
...
*/           
        ...
        <?php //v1.1.7.1a Begin ?>
         <div id="buy_group_varName_area" class="screen-box">  
            ...
            <?php //v1.1.8.0 begin ?>
            <span id='buy_group_varName_addl_info'> 
              <?php _e('( <em>Changes To &nbsp; lowercase &nbsp; , &nbsp; removes leading and trailing spaces </em>)', 'vtprd'); ?>
              <br><br>
              <?php _e('( <em>Enter full Variation / Attribute Names: &nbsp; "|" separating values , &nbsp; "+" combining values </em>)', 'vtprd'); ?>            
              <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <?php _e('<em>If an Attribute Name has a space in the name between words, </em>', 'vtprd'); ?>
               <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
              <?php _e(' <em>and the name is not found in testing, </em>', 'vtprd'); ?>
               <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                   
              <?php _e(' <em>try replacing the space in the name with a dash "-" </em>', 'vtprd'); ?> 
               <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
              <?php _e('( <em>This applies only to Attribute Names, and not Variation Names... </em>)', 'vtprd');  ?>            
            </span>
            <?php //v1.1.8.0 end ?>
    ...
    ?>                                             
        ...
        <?php //v1.1.7.1a Begin ?>
         <div id="action_group_varName_area" class="screen-box">  
            ...
            <?php //v1.1.8.0 begin ?>
            <span id='action_group_varName_addl_info'> 
              <?php _e('( <em>Changes To &nbsp; lowercase &nbsp; , &nbsp; removes leading and trailing spaces </em>)', 'vtprd'); ?>
              <br><br>
              <?php _e('( <em>Enter full Variation / Attribute Names: &nbsp; "|" separating values , &nbsp; "+" combining values </em>)', 'vtprd'); ?>            
              <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
