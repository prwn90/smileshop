...
= NEW Bulk Pricing in a single rule! (SEE "How to set up BULK PRICING" below) =

= OVERVIEW =

*   Bogo Deals (buy one get one) 
*   Category Pricing
*   NEW Bulk Pricing in a single rule!  Use the Bulk option for simple deals as well!  =
*   Catalog Pricing
*   Schedulable
...
*   NEW Order History CART discount reporting  
...
= How to set up BULK PRICING / PRICING TABLES [NEW!] =
...
Buy Group Section
Buy Group Product Filter : [your choice]
Buy Group Pricing Table 
...
Checkout Message : NEW WILDCARD message options for BULK rules
...
Buy 1 get 1 at a discount = Buy 2 get 1 of them at a discount!
...
Buy Rule Usage Count  : [your choice]
